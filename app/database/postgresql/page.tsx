                    ...
                    <div className="max-w-4xl mx-auto">
                            ...
                            <div className="p-8 border-b border-slate-100 bg-slate-50/50">
                                <div className="flex items-start space-x-5">
                                    <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center overflow-hidden border border-slate-100 shadow-sm p-2">
                                        <img
                                            src="https://www.google.com/s2/favicons?domain=postgresql.org&sz=128"
                                            alt="PostgreSQL"
                                            className="w-10 h-10 object-contain"
                                        />
                                    </div>
                                    <div>
                                        <h3 className="text-2xl font-bold text-slate-800 mb-1">PostgreSQL Integration</h3>
                                        <p className="text-slate-500">Connect your PostgreSQL database for real-time data indexing and AI grounding.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="p-8 space-y-8">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="space-y-2">
                                            <label className="flex items-center text-sm font-semibold text-slate-700">
                                                <Key className="w-4 h-4 mr-2 text-[#336791]" />
                                                Port
                                            </label>
                                            <input
                                    ...
                                    <div className="space-y-2">
                                        <label className="flex items-center text-sm font-semibold text-slate-700">
                                            <DbIcon className="w-4 h-4 mr-2 text-[#336791]" />
                                            Database Name
                                        </label>
                                        <input
                                            className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#336791]/20 focus:border-[#336791] transition-all outline-none text-slate-800"
                                            type="text"
                                            placeholder="leucadia_knowledge"
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="p-6 bg-emerald-50/50 border border-emerald-100 rounded-2xl flex space-x-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-800 mb-1">Optimized Performance</h4>
                                    <p className="text-sm text-slate-600">Incremental indexing ensures your AI knowledge is always up-to-date with minimal DB load.</p>
                                </div>
                            </div>
                        </div>
                    </div>
